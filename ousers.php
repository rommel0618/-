<?php 
    ...
    $nuser_sql = "select * from yhq_nuser";
    $nusers = $pdo->query($nuser_sql)->fetchAll(PDO::FETCH_ASSOC);
    $openid = $_GET['openid']; 
    $ouser_sql = "select * from yhq_ouser where openid='".$openid."'";
    $ouser = $pdo->query($ouser_sql)->fetch(PDO::FETCH_ASSOC);
            ...
            <div class="row">
                <div class="col-xs-12 col-md-8 col-sm-6 center" style="height:300px; overflow:scroll;">
                    <table class="table table-bordered">
                        ...
                        <tbody> 
                            <?php foreach ($nusers as $key => $nuser): ?>
                                <tr>
                                    <td><?php echo $nuser['name'];?></td>
                                    <td><a href="tel:<?php echo $ouser['mobile'];?>"></a><?php echo $nuser['mobile'];?></td>
                                    <td><?php echo $nuser['remark'];?></td>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="remark" id="remark" name="" cols="30" rows="10"><?php echo $ouser['remark'];?></textarea>
                            </div>
                        </form>
                    </div>
